...
DASHBOARD_AR_LABELS = {
    ...
    "Project": "مشروع",
    "Apply": "تقديم",
    "Scholarship Application": "طلب منحة",
...
GOALS_AR_LABELS = {
    ...
    "إتقان مفاهيم البرمجة الأساسية": "إتقان مفاهيم البرمجة الأساسية",
    "إتقان التفكير البرمجي": "إتقان التفكير البرمجي",
    "إتقان أساسيات Python": "إتقان أساسيات Python",
    "إتقان Debugging الأساسي": "إتقان Debugging الأساسي",
...
TASK_AR_LABELS_V529.update({
    ...
    "الوقاية الصحية": "الوقاية الصحية",
    "العادات الصحية": "العادات الصحية",
    "العناية الصحية": "العناية الصحية",
    ...
    "الراحة النفسية": "الراحة النفسية",
    "تنفيذ المهمة": "تنفيذ المهمة",
    "متابعة العادة": "متابعة العادة",
    "تثبيت العادة": "تثبيت العادة",
    "تجهيز مسبق": "تجهيز مسبق",
    "فحص سريع": "فحص سريع",
    ...
    "التنمية الذاتية": "التنمية الذاتية",
    "السير الذاتية": "السير الذاتية",
    "الروايات": "الروايات",
    "الأدب": "الأدب",
    "الدين": "الدين",
    "التفسير": "التفسير",
    ...
    "الفقه": "الفقه",
    "العقيدة": "العقيدة",
    "قراءة موجهة": "قراءة موجهة",
    "قراءة تحليلية": "قراءة تحليلية",
    "قراءة مكثفة": "قراءة مكثفة",
    "قراءة سريعة": "قراءة سريعة",
    "فهم المقروء": "فهم المقروء",
    "تدوين فوائد": "تدوين فوائد",
    "اختيار موضوع": "اختيار موضوع",
    "جمع مراجع": "جمع مراجع",
    "قراءة أوراق علمية": "قراءة أوراق علمية",
    "تحليل النتائج": "تحليل النتائج",
    "توثيق المراجع": "توثيق المراجع",
    "كتابة البحث": "كتابة البحث",
    "مراجعة البحث": "مراجعة البحث",
    "استخراج أفكار": "استخراج أفكار",
    "بناء خريطة ذهنية": "بناء خريطة ذهنية",
    "مقارنة": "مقارنة"
})


TASK_AR_LABELS_V529.update({
    "فهم الفكرة العامة": "فهم الفكرة العامة",
    "استخراج التفاصيل": "استخراج التفاصيل",
    "فهم الاستنتاجات": "فهم الاستنتاجات",
    "فهم المفردات من السياق": "فهم المفردات من السياق",
    "القراءة السريعة": "القراءة السريعة",
    "القراءة التحليلية": "القراءة التحليلية",
    "القراءة الأكاديمية": "القراءة الأكاديمية",
    "قراءة المقالات": "قراءة المقالات",
    "قراءة الأخبار": "قراءة الأخبار",
    "قراءة القصص": "قراءة القصص",
    "فهم الفكرة الرئيسية": "فهم الفكرة الرئيسية",
    "فهم التفاصيل": "فهم التفاصيل",
    "فهم اللهجات": "فهم اللهجات",
    "الاستماع الأكاديمي": "الاستماع الأكاديمي",
    "الاستماع اليومي": "الاستماع اليومي",
    "المحاضرات": "المحاضرات",
    "الأخبار": "الأخبار",
    "المحادثات": "المحادثات",
    "البودكاست": "البودكاست",
    "المحادثات اليومية": "المحادثات اليومية",
    "العروض التقديمية": "العروض التقديمية",
    "المناقشات": "المناقشات",
    "وصف الصور": "وصف الصور",
    "التحدث الأكاديمي": "التحدث الأكاديمي",
    "مقابلات القبول": "مقابلات القبول",
    "مقابلات العمل": "مقابلات العمل",
    "الكتابة العامة": "الكتابة العامة",
    "الكتابة الأكاديمية": "الكتابة الأكاديمية",
    "كتابة المقالات": "كتابة المقالات",
    "كتابة الرسائل": "كتابة الرسائل",
    "كتابة التقارير": "كتابة التقارير",
    "كتابة الملاحظات": "كتابة الملاحظات",
    "كتابة الحجج": "كتابة الحجج",
    "الأزمنة": "الأزمنة",
    "بناء الجملة": "بناء الجملة",
    "أدوات الربط": "أدوات الربط",
    "الجمل الشرطية": "الجمل الشرطية",
    "المبني للمجهول": "المبني للمجهول",
    "حروف الجر": "حروف الجر",
    "الأخطاء الشائعة": "الأخطاء الشائعة",
    "تطبيق القواعد في الكتابة": "تطبيق القواعد في الكتابة",
    "مفردات يومية": "مفردات يومية",
    "مفردات أكاديمية": "مفردات أكاديمية",
    "مفردات الاختبارات": "مفردات الاختبارات",
    "مرادفات ومتضادات": "مرادفات ومتضادات",
    "تعبيرات شائعة": "تعبيرات شائعة",
    "مفردات حسب الموضوع": "مفردات حسب الموضوع",
    "تصحيح مخارج الحروف": "تصحيح مخارج الحروف",
    "النبر والتنغيم": "النبر والتنغيم",
    "الطلاقة": "الطلاقة",
    "المحاكاة الصوتية": "المحاكاة الصوتية",
    "تسجيل الصوت": "تسجيل الصوت",
    "تقليد المتحدث": "تقليد المتحدث",
    "المقالات الأكاديمية": "المقالات الأكاديمية",
    "الأبحاث": "الأبحاث",
    "المناقشات الأكاديمية": "المناقشات الأكاديمية",
    "المفردات الأكاديمية": "المفردات الأكاديمية",
    "قراءة نص": "قراءة نص",
    "حل أسئلة فهم": "حل أسئلة فهم",
    "تلخيص النص": "تلخيص النص",
    "تحليل النص": "تحليل النص",
    "استخراج الأفكار الرئيسية": "استخراج الأفكار الرئيسية",
    "استخراج المفردات": "استخراج المفردات",
    "تسجيل الملاحظات": "تسجيل الملاحظات",
    "الاستماع للمقطع": "الاستماع للمقطع",
    "تدوين الملاحظات": "تدوين الملاحظات",
    "الإجابة عن الأسئلة": "الإجابة عن الأسئلة",
    "التحدث الحر": "التحدث الحر",
    "تسجيل صوتي": "تسجيل صوتي",
    "محاكاة مقابلة": "محاكاة مقابلة",
    "كتابة مسودة": "كتابة مسودة",
    "تصحيح الكتابة": "تصحيح الكتابة",
    "إعادة الصياغة": "إعادة الصياغة",
    "تحسين الأسلوب": "تحسين الأسلوب",
    "تحديد الفكرة الرئيسية": "تحديد الفكرة الرئيسية",
    "تمييز المعلومات المهمة": "تمييز المعلومات المهمة",
    "استنتاج المعنى": "استنتاج المعنى",
    "تخمين المعنى من السياق": "تخمين المعنى من السياق",
    "كتابة جمل جديدة": "كتابة جمل جديدة",
    "قراءة بوقت محدد": "قراءة بوقت محدد",
    "تحديد الكلمات المفتاحية": "تحديد الكلمات المفتاحية",
    "تدريب Skimming": "تدريب Skimming",
    "تدريب Scanning": "تدريب Scanning",
    "الاستماع لمتحدثين مختلفين": "الاستماع لمتحدثين مختلفين",
    "مقارنة اللهجات": "مقارنة اللهجات",
    "الاستماع لمحاضرة": "الاستماع لمحاضرة",
    "تلخيص المحاضرة": "تلخيص المحاضرة",
    "مراجعة المصطلحات": "مراجعة المصطلحات",
    "الاستماع لحوار يومي": "الاستماع لحوار يومي",
    "استخراج عبارات": "استخراج عبارات",
    "تطبيق العبارات": "تطبيق العبارات",
    "الاستماع لخبر": "الاستماع لخبر",
    "تلخيص الخبر": "تلخيص الخبر",
    "الاستماع لمحادثة": "الاستماع لمحادثة",
    "تقليد العبارات": "تقليد العبارات",
    "الاستماع لحلقة": "الاستماع لحلقة",
    "تدوين الفوائد": "تدوين الفوائد",
    "محاكاة حوار": "محاكاة حوار",
    "تحضير عرض شفهي": "تحضير عرض شفهي",
    "تسجيل العرض": "تسجيل العرض",
    "مراجعة الأداء": "مراجعة الأداء",
    "مناقشة موضوع": "مناقشة موضوع",
    "عرض رأي": "عرض رأي",
    "الرد على أسئلة": "الرد على أسئلة",
    "تقييم الطلاقة": "تقييم الطلاقة",
    "وصف صورة": "وصف صورة",
    "تسجيل الإجابة": "تسجيل الإجابة",
    "إعادة المحاولة": "إعادة المحاولة",
    "شرح فكرة أكاديمية": "شرح فكرة أكاديمية",
    "استخدام مفردات أكاديمية": "استخدام مفردات أكاديمية",
    "تحسين الثقة": "تحسين الثقة",
    "التعريف بالنفس": "التعريف بالنفس",
    "بناء مقدمة": "بناء مقدمة",
    "كتابة فقرات": "كتابة فقرات",
    "مراجعة الخاتمة": "مراجعة الخاتمة",
    "تحسين الترابط": "تحسين الترابط",
    "مراجعة الحجة": "مراجعة الحجة",
    "تنظيم العناوين": "تنظيم العناوين",
    "تلخيص النتائج": "تلخيص النتائج",
    "تنظيم النقاط": "تنظيم النقاط",
    "اختصار الأفكار": "اختصار الأفكار",
    "كتابة حجة": "كتابة حجة",
    "دعم الرأي بأمثلة": "دعم الرأي بأمثلة",
    "مراجعة المنطق": "مراجعة المنطق"
})

TASK_OFFICIAL_KEEP_V529 = {
...
def task_ar(value):
    if value is None:
        return ""
    text = str(value)
    if text in TASK_OFFICIAL_KEEP_V529:
        return text
    return TASK_AR_LABELS_V529.get(text, text)

def repeat_days_ar(value):
    if not value:
        return "غير محدد"
    labels = {
...
def create_app():
    ...
    def index():
        ...
        def build_home_next_action():
            ...
            if active_goals:
                ...
                return {
                    ...
                    "badge": "ابدأ بخطوة",
                    "title": goal.title,
                    "reason": "لديك هدف نشط بلا مهام مفتوحة كافية. أنشئ مهمة صغيرة تخدمه اليوم.",
                    "skill": goal.category,
                    "category": goal.current_level,
            ...
            return {
                ...
                "tone": "steady",
                "badge": "بداية منظمة",
                "title": "أنشئ أول هدف أو مهمة",
                "reason": "ابدأ بخطوة صغيرة حتى يستطيع EduPath AI ترتيب يومك واقتراح المسار المناسب.",
                "skill": "",
                "category": "",
                "minutes": None,
                "priority": None,
        ...
        next_action = build_home_next_action()
        admin_messages = []
