...
const GOAL_CONFIG_V524 = {
    ...
    "الرياضيات": {
        ...
        states: {
            ...
            "التكامل::اختبار قصير": {current:["أحتاج مراجعة","أحل اختبارات قصيرة","أحل اختبارات كاملة","أخرى"], target:["تحسين الدرجة","اجتياز الاختبارات","تقليل الأخطاء","إتقان التكامل","أخرى"], commitment:["اختبار أسبوعي","اختبار تجريبي","تحليل الأخطاء","مراجعة نقاط الضعف","أخرى"]},
            "التكامل::اختبار تجريبي": {current:["أحتاج مراجعة","أحل اختبارات قصيرة","أحل اختبارات كاملة","أخرى"], target:["تحسين الدرجة","اجتياز الاختبارات","تقليل الأخطاء","إتقان التكامل","أخرى"], commitment:["اختبار أسبوعي","اختبار تجريبي","تحليل الأخطاء","مراجعة نقاط الضعف","أخرى"]},
            ...
            "التكامل::المساحة تحت المنحنى": {current:["لا أعرف الفكرة","أحسب مساحات بسيطة","أحسب مساحات متنوعة","أخرى"], target:["إتقان حساب المساحات","تفسير النتائج","حل التطبيقات","أخرى"], commitment:["10 مسائل","حل تدريبات","اختبار","أخرى"]},
            "التكامل::المساحة فوق المنحنى": {current:["لا أعرف الفكرة","أفهم الإشارة","أحسب مساحات بسيطة","أخرى"], target:["فهم المساحة فوق المنحنى","تفسير الإشارات","حل مسائل متنوعة","أخرى"], commitment:["حل تدريبات","رسم بياني","اختبار","أخرى"]},
