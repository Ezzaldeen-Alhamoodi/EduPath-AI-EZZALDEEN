...
const GOAL_CONFIG_V524 = {
    ...
    "الرياضيات": {
        ...
        states: {
            ...
            "التكامل::التطبيقات الهندسية": {current:["لا أعرف التطبيقات","أفهم بعض الأفكار","أحل مسائل بسيطة","أخرى"], target:["فهم التطبيقات الهندسية","ربط التكامل بالهندسة","حل مسائل متنوعة","أخرى"], commitment:["5 مسائل","10 مسائل","تحليل التطبيقات","اختبار","أخرى"]},
