...
const GOAL_CONFIG_V524 = {
    ...
    "الرياضيات": {
        ...
        states: {
            ...
            "التكامل::المراجعة الشاملة": {current:["أحتاج مراجعة","راجعت جزءاً بسيطاً","أراجع بانتظام","أحل مسائل متنوعة","أخرى"], target:["إكمال المراجعة","تقوية نقاط الضعف","جاهزية كاملة","إتقان أساسيات التكامل","أخرى"], commitment:["مراجعة يومية","اختبار أسبوعي","تحليل الأخطاء","مراجعة نقاط الضعف","أخرى"]},
            "التكامل::اختبار قصير": {current:["أحتاج مراجعة","أحل اختبارات قصيرة","أحل اختبارات كاملة","أخرى"], target:["تحسين الدرجة","اجتياز الاختبارات","تقليل الأخطاء","إتقان أساسيات التكامل","أخرى"], commitment:["اختبار أسبوعي","اختبار تجريبي","تحليل الأخطاء","مراجعة نقاط الضعف","أخرى"]},
            "التكامل::اختبار تجريبي": {current:["أحتاج مراجعة","أحل اختبارات قصيرة","أحل اختبارات كاملة","أخرى"], target:["تحسين الدرجة","اجتياز الاختبارات","تقليل الأخطاء","إتقان أساسيات التكامل","أخرى"], commitment:["اختبار أسبوعي","اختبار تجريبي","تحليل الأخطاء","مراجعة نقاط الضعف","أخرى"]},
