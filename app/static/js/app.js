...
const SMART_TASK_DATA = {
  ...
  "الرياضيات": {
    icon: "ر",
    main: ["الحساب الأساسي", "الجبر", "الهندسة", "حساب المثلثات", "المتتاليات", "ما قبل التفاضل", "التفاضل", "التكامل", "المعادلات التفاضلية", "الإحصاء", "الاحتمالات", "الجبر الخطي", "المنطق الرياضي", "الرياضيات المتقطعة", "رياضيات البرمجة", "رياضيات الذكاء الاصطناعي", "رياضيات علوم البيانات", "رياضيات الأمن السيبراني", "أخرى"],
    sub: {
      "الحساب الأساسي": ["الأعداد الطبيعية", "الأعداد الصحيحة", "القيمة المكانية", "مقارنة الأعداد", "ترتيب الأعداد", "الجمع", "الطرح", "الضرب", "القسمة", "ترتيب العمليات", "التقدير والتقريب", "المسائل اللفظية الأساسية", "المراجعة الشاملة", "اختبار قصير", "الكسور", "الأعداد العشرية", "النسب", "التناسب", "النسبة المئوية", "القياس", "تحويل الوحدات", "المتوسط الحسابي", "التطبيقات الحياتية", "أخرى"],
      "أخرى": ["أخرى"]
    },
    detail: {
      ...
      "المراجعة الشاملة": ["مراجعة العمليات الأساسية", "مراجعة الأخطاء", "تدريب شامل", "حل مسائل متنوعة", "مراجعة الكسور", "مراجعة الأعداد العشرية", "مراجعة النسب", "مراجعة النسبة المئوية", "مراجعة القياس", "أخرى"],
      "اختبار قصير": ["اختبار في الجمع والطرح", "اختبار في الضرب والقسمة", "اختبار في ترتيب العمليات", "اختبار شامل قصير", "اختبار الكسور", "اختبار الأعداد العشرية", "اختبار النسب", "اختبار النسبة المئوية", "اختبار شامل", "أخرى"],
    ...
    training: ["دراسة الدرس", "حل تمارين", "حل مسائل", "تدريب ذهني", "حل مسائل حياتية", "مراجعة القوانين", "مراجعة القواعد", "مراجعة جدول الضرب", "تحليل الأخطاء", "اختبار قصير", "تدريب يومي", "مراجعة شاملة", "تطبيق عملي", "أخرى"]
  },
...
/* EduPath AI v5.5.70: Tasks Math Basic Arithmetic Part 1 */
(function updateTasksMathBasicArithmeticPart1V5570() {
    if (typeof SMART_TASK_DATA === "undefined" || !SMART_TASK_DATA["الرياضيات"]) return;

    const math = SMART_TASK_DATA["الرياضيات"];
    math.sub = math.sub || {};
    math.detail = math.detail || {};

    // تحديث خاص بصفحة المهام فقط: الفئة الرئيسية "الحساب الأساسي" داخل نوع المهمة "الرياضيات".
    // لا يتم تغيير التصميم أو الخانات، ويتم استخدام الخانات الحالية فقط:
    // الفئة الرئيسية ← الفئة الفرعية ← الموضوع التفصيلي ← نوع النشاط.
    math.sub["الحساب الأساسي"] = [
        "الأعداد الطبيعية",
        "الأعداد الصحيحة",
        "القيمة المكانية",
        "مقارنة الأعداد",
    ...
    Object.assign(math.detail, {
        ...
        "اختبار قصير": [
            "اختبار في الجمع والطرح",
            "اختبار في الضرب والقسمة",
            "اختبار في ترتيب العمليات",
            "اختبار شامل قصير",
            "أخرى"
        ],
        "أخرى": ["أخرى"]
...
/* End EduPath AI v5.5.70: Tasks Math Basic Arithmetic Part 1 */
