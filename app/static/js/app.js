...
const SMART_TASK_DATA = {
  ...
  "الرياضيات": {
    icon: "ر",
    main: ["الحساب الأساسي","الجبر","الهندسة","المثلثات","التفاضل والتكامل","الاحتمالات","الإحصاء","الجبر الخطي","الرياضيات المتقطعة","اختبارات سابقة","أخرى"],
    sub: {
      "الحساب الأساسي": ["الأعداد الطبيعية","الأعداد الصحيحة","القيمة المكانية","مقارنة الأعداد","ترتيب الأعداد","الجمع","الطرح","الضرب","القسمة","ترتيب العمليات","التقدير والتقريب","المسائل اللفظية الأساسية","المراجعة الشاملة","اختبار قصير","أخرى"],
    ...
    detail: {
      ...
      "أخرى": ["موضوع مخصص","أخرى"],
      "الجبر": ["مجموعة تمارين","قانون","سؤال سابق","موضوع صعب","أخرى"]
    },
    trainingByTopic: {
      "الحساب الأساسي": ["دراسة الدرس","حل تمارين","حل مسائل","تدريب ذهني","مراجعة القوانين","مراجعة جدول الضرب","تحليل الأخطاء","اختبار قصير","تدريب يومي","مراجعة شاملة","أخرى"]
    },
...
function updateSmartTaskFields() {
    ...
    function refreshDetails() {
        ...
        if (!trainingValues) {
            trainingValues =
                (config.trainingBySub && config.trainingBySub[selectedSkill]) ||
                (config.trainingByTopic && config.trainingByTopic[selectedTopic]) ||
                config.training ||
                ["دراسة", "تدريب", "مراجعة", "أخرى"];
        }
