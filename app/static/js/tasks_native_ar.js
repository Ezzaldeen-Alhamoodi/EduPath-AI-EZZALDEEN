...
window.EDUPATH_TASKS_AR_DATA = {
  ...
  "الرياضيات": {
    ...
    detail: {
      ...
      "المراجعة الشاملة": ["مراجعة العمليات الأساسية","مراجعة الأخطاء","تدريب شامل","حل مسائل متنوعة","مراجعة الكسور","مراجعة الأعداد العشرية","مراجعة النسب","مراجعة النسبة المئوية","مراجعة القياس","مراجعة العبارات","مراجعة المعادلات","مراجعة الدوال","مراجعة المتباينات","مراجعة الأنظمة","مراجعة كثيرات الحدود","مراجعة التحليل","مراجعة الأسس والجذور","مراجعة الأشكال","مراجعة الزوايا","مراجعة المحيط","مراجعة المساحة","مراجعة الهندسة الإحداثية","مراجعة التحويلات","مراجعة المفاهيم","مراجعة النظريات","أخرى"],
      "اختبار قصير": ["اختبار في الجمع والطرح","اختبار في الضرب والقسمة","اختبار في ترتيب العمليات","اختبار شامل قصير","اختبار الكسور","اختبار الأعداد العشرية","اختبار النسب","اختبار النسبة المئوية","اختبار العبارات","اختبار المعادلات","اختبار التطبيقات","اختبار الدوال","اختبار المتباينات","اختبار الأنظمة","اختبار كثيرات الحدود","اختبار التحليل","اختبار الأسس والجذور","اختبار الزوايا","اختبار المثلثات","اختبار الدائرة","اختبار القياس","اختبار الإحداثيات","اختبار التحويلات","اختبار البرهان","اختبار التطابق","اختبار التشابه","اختبار شامل","أخرى"],
